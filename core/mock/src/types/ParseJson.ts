/**
 * https://github.com/jamiebuilds/json-parser-in-typescript-very-bad-idea-please-dont-use/blob/main/json-parser-in-typescript-very-bad-idea-please-dont-use.ts
 */
