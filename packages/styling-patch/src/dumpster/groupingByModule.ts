...
export const dumpUsefulCssKeywordList_byModule: Function = (usefulCssKeywordList: Array<object>): void => {
  mdnModuleGroupList.map((moduleGroup: string) => {
    ...
    `
    const thisGroupKeywordList = alasql(getThisGroupKeywordList, [usefulCssKeywordList])
